...
}const entities=(_pluralize=(0,pluralize/* pluralize */._)(props.pageContext.entityName))!==null&&_pluralize!==void 0?_pluralize:'Articles';return/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement((external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(Seo/* Seo */.p,{title:`All ${entities}`,useTitleTemplate:true}),/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(Page/* Page */.T,null,/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(Section/* Section */.$,{anchor:"articleListing",heading:entities},/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement("div",{className:Filter},"Select categories to filter ",entities.toLocaleLowerCase(),/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(Slider/* Slider */.i,{additionalClasses:[Options]},filterOptions.map((option,key)=>{return/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement("div",{key:key,role:"button",onClick:()=>handleFilterOptionClick(option.label),className:[Option,option.selected===true?Selected:null].join(' ')},option.label," (",option.relatedArticleIds.length,")");}))),/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement("div",{className:Listing},articles.filter(article=>!filterSelected||selectedArticleIds.includes(article.id)).slice(0,shownArticlesNumber).map((article,key)=>{return/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(ArticleCard/* ArticleCard */.T,{key:key,showBanner:true,data:{image:article.banner,title:article.title,category:article.categories.join(' / '),publishedAt:new Date(article.date.replace(/-/g,'/')),link:article.slug,readingTime:article.readingTime.text}});})),filterSelected&&selectedArticleIds.length>shownArticlesNumber||!filterSelected&&articles.length>shownArticlesNumber?/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement("div",{className:LoadMore},/*#__PURE__*/external_C_Users_maria_Github_marianaarboleda_gie_web_node_modules_react_index_js_default().createElement(Button/* Button */.z,{type:Button/* ButtonType.BUTTON */.L.BUTTON,label:"Load More",onClickHandler:()=>handleLoadMoreButtonClick(articles.length,filterSelected?selectedArticleIds.length:undefined)})):null)));}// Helper function to calculate a sorted array of filter options based on the given articles
